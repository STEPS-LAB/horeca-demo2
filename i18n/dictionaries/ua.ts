const ua = {
  ...
  sections: {
    ...
    gallery: {
      ...
      title: 'Візуальна подорож',
      viewAllRooms: 'Переглянути всі номери',
      images: {
        exterior: 'Територія готелю та головний корпус',
        spaRoom: 'Доріжки та зелені зони на території',
        dining: 'Тераса та зони відпочинку',
        pool: 'Басейн на території готелю',
        spaArea: 'Простір для відпочинку на відкритому повітрі',
        lobby: 'Центральна зона готелю',
      },
    },
    testimonials: {
  ...
  aiConcierge: {
    title: 'AI-консьєрж',
    online: 'Онлайн · демо-відповіді',
    openLabel: 'Відкрити чат AI-консьєржа',
    fabLine: 'Запитайте про відпочинок',
    welcome:
      'Вітаю! Я ваш AI-консьєрж. Запитайте про номери, спа, ресторан чи активності — лише демо-відповіді.',
    placeholder: 'Напишіть запитання…',
    send: 'Надіслати',
    suggestions: [
      'Які страви ви рекомендуєте?',
      'Що обрати в спа для релаксу?',
      'Який номер для пари?',
      'Як забронювати відпочинок?',
    ],
  },
